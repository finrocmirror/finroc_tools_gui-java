...
public abstract class AbstractFile implements Serializable, XMLSerializable {
    ...
    /** Reference possibly discovered in XML file generated by XStream (needs to be resolved after deserialization) */
    private transient String deserializationReference;
    ...
    public void deserialize(XMLNode node) throws Exception {
        if (node.hasAttribute("reference")) {
            deserializationReference = node.getStringAttribute("reference");
        }
    ...
    /**
     * @return Reference possibly discovered in XML file generated by XStream (needs to be resolved after deserialization)
     */
    public String getDeserializationReference() {
        return deserializationReference;
    }
}
